    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.inputContainer}>
        ...
        <Text style={styles.noteText}>
          * Akan dihubungi apabila terjadi masalah
        </Text>
      </View>

      <Text style={styles.paymentOptionsTitle}>Pembayaran</Text>
      <View style={styles.paymentOptionsContainer}>
        <View style={[styles.paymentOption, paymentMethod === "ewallet"]}>
          <RadioButton
            value="ewallet"
            status={paymentMethod === "ewallet" ? "checked" : "unchecked"}
            onPress={() => setPaymentMethod("ewallet")}
            color={paymentMethod === "ewallet" ? "pink" : "black"}
          />
          <Text style={styles.paymentOptionText}>E-Wallet</Text>
        </View>
        <View style={[styles.paymentOption, paymentMethod === "bank"]}>
          <RadioButton
            value="second"
            status={paymentMethod === "bank" ? "checked" : "unchecked"}
            onPress={() => setPaymentMethod("bank")}
            color={paymentMethod === "bank" ? "pink" : "black"}
          />
        ...
        <View style={styles.inputContainer}>
          ...
          <View style={styles.bankOptionsContainer}>
            <TouchableOpacity
              style={[
                styles.bankOption,
                bank === "bca" && styles.selectedOption,
              ]}
              onPress={() => setBank("bca")}
            >
            ...
            <TouchableOpacity
              style={[
                styles.bankOption,
                bank === "bni" && styles.selectedOption,
              ]}
              onPress={() => setBank("bni")}
            >
            ...
            <TouchableOpacity
              style={[
                styles.bankOption,
                bank === "mandiri" && styles.selectedOption,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.bankOption,
                bank === "bri" && styles.selectedOption,
              ]}
              onPress={() => setBank("bri")}
            >
        ...
        <View style={styles.inputContainer}>
          ...
          <View style={styles.bankOptionsContainer}>
            <TouchableOpacity
              style={[
                styles.bankOption,
                eWallet === "ovo" && styles.selectedOption,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.bankOption,
                eWallet === "gopay" && styles.selectedOption,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.bankOption,
                eWallet === "dana" && styles.selectedOption,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.bankOption,
                eWallet === "shopeepay" && styles.selectedOption,
              ]}
